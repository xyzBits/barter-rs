# Barter-Instrument
Barter-Instrument 包含核心的 Exchange（交易所）、Instrument（交易工具）和 Asset（资产）数据结构及相关实用工具。

**请参阅：[`Barter`]、[`Barter-Data`]、[`Barter-Execution`] 和 [`Barter-Integration`] 获取其他 Barter 库的完整文档。**
